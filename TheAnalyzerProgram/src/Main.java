...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            ...
            System.out.println("Максимальное количество букв a (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("Максимальное количество букв b (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("Максимальное количество букв c (" + maxTextABC.getCount() + "):\n" + maxTextABC.getText() + "\n");
        }).start();
    }
